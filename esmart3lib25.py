...
# skagmo.com, 2018
#                                                       fields['daily'] = int.from_bytes(self.data[21:22], byteorder='little')
...
DEVICE_MODE = ["IDLE_1", "CC_3", "CV_4", "FLOAT_5", "STARTING_2"]
                                ...
                                if (len(self.data) == self.target_len):
                                        ...
                                        if (self.data[2] == 3):
                                                ...
                                                if (self.data[3] == 0):
                                                        ...
                                                        fields['pv_volt'] = int.from_bytes(self.data[9:11], byteorder='little')
                                                        fields['bat_volt'] = int.from_bytes(self.data[11:13], byteorder='little')
                                                        fields['chg_cur'] = int.from_bytes(self.data[13:15], byteorder='little')
                                                        fields['load_volt'] = int.from_bytes(self.data[17:19], byteorder='little')
                                                        fields['load_cur'] = int.from_bytes(self.data[19:21], byteorder='little')
